...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return ` <div class="d-flex flex-end">
                                <a title ="Login As" href="${loginAsUrl}" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px "><i class="las la-plug fs-2" ></i></a>
