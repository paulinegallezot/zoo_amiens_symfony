...
class MedicalReportVoter extends Voter
{
    ...
    protected function supports(string $attribute, $subject): bool
    {
        return in_array($attribute, [self::EDIT, self::AJAX_DELETE])
            && $subject instanceof MedicalReport;
    }
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        switch ($attribute) {
            ...
            case self::AJAX_DELETE:
                return $this->canEditOrDelete($medicalReport, $user);
        }

        return false;
    }

    private function canEditOrDelete(MedicalReport $medicalReport, User $user): bool
    {
